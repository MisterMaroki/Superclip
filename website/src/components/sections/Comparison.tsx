		...
		<section id="compare" className="relative py-32">
			<div className="mx-auto max-w-[var(--container)] px-6">
						...
						<div className="grid grid-cols-[1fr_120px_120px] sm:grid-cols-[1fr_150px_150px] items-center border-b border-white/[0.06] px-6 py-4">
							...
							<span className="text-center">
								<span className="inline-flex items-center gap-1.5">
									<img src="/app-icon.png" alt="" className="h-4 w-4" />
                ...
                `}
							>
								<span
									className={`text-[13px] ${row.highlight ? 'font-semibold text-white/80' : 'text-white/55'}`}
								>
									{row.feature}
								</span>
						...
						<div className="flex flex-col md:flex-row md:items-center gap-6">
							<div className="flex-1">
								...
								<p className="text-[14px] text-white/45 leading-relaxed max-w-lg">
									...
									<span className="text-white/70 font-semibold">$99/yr</span>{' '}
				...
				<FadeIn delay={0.35}>
					<div className="mt-8 text-center">
						<p className="text-[14px] text-white/30">
							Paste + CleanShot X ={' '}
							<span className="text-white/50 font-medium">$129/yr</span>.
							Superclip ={' '}
							<span className="text-emerald-400 font-semibold">$14.99/yr</span>.
						</p>
					</div>
				</FadeIn>
			</div>
